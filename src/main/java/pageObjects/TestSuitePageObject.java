...
public class TestSuitePageObject extends Base{
	...
	private WebElement logOut; // i moved this from bottom

	
	@FindBy(how = How.XPATH, using ="//a [text()='Login to Class']")
	
	private WebElement canvasLink;
	
	@FindBy(how = How.XPATH, using ="//a[text()='Tablets']")
	
	private WebElement tabletNavigationElement;
	
	@FindBy(how = How.XPATH, using ="//span[text()='Add to Cart']")
	
	WebElement tabletAddToCartElement;
	...
	public void clickOnCanvasLink() {
		canvasLink.click();
	}
	
	public void clickOnTabletNav() {
		tabletNavigationElement.click();
	}
	
	public void clickOnTabletAddToCart() {
		
		tabletAddToCartElement.click();
